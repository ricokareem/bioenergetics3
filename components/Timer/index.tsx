...
export type TimerProps = {
  ...
  onPause?: any; // opt
  onResume?: any; // opt
  onTimeElapsed?: any; // opt
  radius: number;
  reverseCount: boolean;
  seconds?: number;
  startAt?: number;
  shadowColor: string; // opt
  subTextStyle?: typeof Text;
  textStyle?: Text;
  updateText?: any; // opt
};
...
function calcInterpolationValuesForCircleRotate(
  animatedValue,
  { shadowColor }
) {
...
> {
  ...
  constructor(props) {
    super(props);
    this.state = { ...getInitialState(props), active: true };
  }
