...
const BeginningHealingSessionScreen = (props) => {
  return (
    <ScrollView style={styles.container}>
      ...
      <Text>
        The energy healing techniques described in this method are touch
        free, non-toxic and health restoring. They were developed in the
        former Soviet Union in the 1980s, and have been extensively studied
        by world-renowned physicists, mathematicians and physicians. These
        techniques have proven to be extremely effective in treating a
        variety of physical ailments. They have shown significant results
        improving circulation, metabolism and to help strengthen the immune
        system and improve speed of recovery. However, they are not intended
        to replace conventional medical treatment of any kind. Both patient
        and healer are strongly encouraged to seek medical advice from a qualified,
